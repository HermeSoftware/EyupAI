...
export default function Home() {
  ...
  const handleSolutionGenerated = (data: {
    solution: Solution;
    parsed: ModelResponse;
    verified: boolean;
  }) => {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <button className="text-primary font-medium">Ana Sayfa</button>
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-foreground mb-3">Sorunuzu Gönderin</h2>
            <p className="text-muted-foreground text-lg">Matematik, geometri, fizik, kimya ve daha fazlası için adım adım çözümler</p>
          </div>
          
          <SolveForm onSolutionGenerated={handleSolutionGenerated} />
        </section>
        ...
        {currentSolution && (
          <section className="mb-12">
            <SolutionCard 
              ...
              parsed={currentSolution.parsed}
              verified={currentSolution.verified}
            />
          </section>
        )}
